...
import com.submission.storyapp.databinding.ActivityRegisterBinding
import com.submission.storyapp.view.ViewModelFactory
import com.submission.storyapp.view.mycustomview.MyButton
import com.submission.storyapp.view.mycustomview.MyEditText
...
class RegisterActivity : AppCompatActivity() {
    ...
    private fun showSuccessDialog() {
        ...
        AlertDialog.Builder(this).apply {
            setTitle("Yeah!")
            setMessage("Registrasi dengan ${binding.edRegisterEmail.text} selesai, silahkan masuk dan belajar di Dicoding")
